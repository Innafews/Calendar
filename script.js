...
const specialDates = [
    ...
    { date: "2026-03-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-04-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-05-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-06-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-07-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-08-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-09-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-10-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-11-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2026-12-02", color: "#00d0ff", label: "数据线抽50次" },

    { date: "2027-01-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-02-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-03-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-04-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-05-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-06-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-07-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-08-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-09-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-10-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-11-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2027-12-02", color: "#00d0ff", label: "数据线抽50次" },

    { date: "2028-01-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-02-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-03-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-04-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-05-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-06-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-07-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-08-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-09-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-10-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-11-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2028-12-02", color: "#00d0ff", label: "数据线抽50次" },

    { date: "2029-01-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-02-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-03-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-04-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-05-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-06-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-07-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-08-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-09-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-10-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-11-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2029-12-02", color: "#00d0ff", label: "数据线抽50次" },

    { date: "2030-01-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-02-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-03-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-04-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-05-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-06-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-07-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-08-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-09-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-10-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-11-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2030-12-02", color: "#00d0ff", label: "数据线抽50次" },

    { date: "2031-01-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-02-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-03-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-04-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-05-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-06-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-07-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-08-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-09-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-10-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-11-02", color: "#00d0ff", label: "数据线抽50次" },
    { date: "2031-12-02", color: "#00d0ff", label: "数据线抽50次" },
    // 你可以继续添加，例如：
